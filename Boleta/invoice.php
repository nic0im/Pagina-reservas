<?php
	...
	$pdf->Cell(150,10,utf8_decode(strtoupper("Arriendos de temporada")),0,0,'L');
	...
	$pdf->Cell(150,9,utf8_decode("Av. Américo Vespucio 1501, Cerrillos, Región Metropolitana"),0,0,'L');
	...
	$pdf->Cell(150,9,utf8_decode("Email: Arriendos@Arriendos.com"),0,0,'L');
	...
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(134,7,utf8_decode("Ignacio Caroca"),0,0,'L');
	$pdf->SetFont('Arial','B',10);
	$pdf->SetTextColor(97,97,97);
	...
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(60,7,utf8_decode("Nicolas Corral"),0,0,'L');
	$pdf->SetTextColor(39,39,51);
	...
	$pdf->SetTextColor(97,97,97);
	$pdf->Cell(109,7,utf8_decode("Av. Américo Vespucio 1501, Cerrillos, Región Metropolitana"),0,0);
	...
	$pdf->Cell(15,8,utf8_decode("Cant. Noches"),1,0,'C',true);
	...
	$pdf->Cell(90,7,utf8_decode("Arriendo Dpto. Viña del mar Habitación Estandar"),'L',0,'C');
	$pdf->Cell(15,7,utf8_decode("1"),'L',0,'C');
	$pdf->Cell(25,7,utf8_decode("$30.000 CLP"),'L',0,'C');
	$pdf->Cell(19,7,utf8_decode("0 CLP"),'L',0,'C');
	$pdf->Cell(32,7,utf8_decode("30.000 CLP"),'LR',0,'C');
	$pdf->Ln(7);
	...
	$pdf->Cell(34,7,utf8_decode("+ $30.000 CLP"),'T',0,'C');
	...
	$pdf->Cell(34,7,utf8_decode("+ $0 CLP"),'',0,'C');
	...
	$pdf->Cell(34,7,utf8_decode("$30.000 USD"),'T',0,'C');
	...
	$pdf->Cell(34,7,utf8_decode("$30.000"),'',0,'C');
	...
	$pdf->Cell(34,7,utf8_decode("$30.000 CLP"),'',0,'C');
